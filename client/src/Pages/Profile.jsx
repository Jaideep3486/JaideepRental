...
export default function Profile() {
  ...
  const handleFileUpload = async (image) => { // this is the function for image upload
    ...
    uploadTask.on(
      ...
      (snapshot) => { // this is the information we get
        const progress =
      ...
      () => { // when the task is done
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => // this function returns the download URL that we get from Firebase
